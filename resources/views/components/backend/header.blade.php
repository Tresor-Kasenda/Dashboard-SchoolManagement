        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="{{ route('dashboard') }}" class="logo-link">
                    <img class="logo-light logo-img" src="{{ asset('images/vinco.svg') }}"
                         srcset="{{ asset('images/vinco.svg') }} 2x"
                         alt="logo">
                    <img class="logo-dark logo-img" src="{{ asset('images/vinco.svg') }}"
                         srcset="{{ asset('images/vinco.svg') }} 2x" alt="logo-dark">
                </a>
            </div>
