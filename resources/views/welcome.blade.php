    ...
    <div class="mx-auto max-w-6xl px-6 md:px-12 lg:px-6 xl:px-0">
        <div
            ...
            <div class="relative ml-auto h-full md:w-1/2">
                ...
                <img class="hidden dark:block" src="/images/milestone-dark.webp" alt="app milestone" width="1174"
                     height="1134">
            </div>

            <div class="md:w-1/2 lg:w-[47%]">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white md:text-4xl lg:text-5xl">Just focus on your
                    business startegy</h2>
                ...
                <div class="space-y-4 divide-y divide-gray-100 dark:divide-gray-800">
                    <div class="mt-8 flex gap-4 md:items-center">
                        <div class="flex h-12 w-12 gap-4 rounded border border-gray-200 dark:border-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                 stroke="currentColor" class="m-auto h-6 w-6 text-gray-700 dark:text-gray-300">
        ...
        <div class="my-20 md:my-32">
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white md:w-2/3 md:text-3xl lg:text-4xl">Customize your
                customer experience, Go beyond with our top products</h3>
            <div class="relative mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div
                    ...
                    <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
                        <img class="w-10" src="/images/security.webp" alt="safety icon illustration" height="512"
                             width="512">
                        <div>
                ...
                <div
                    class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-gray-200 to-white p-px dark:from-gray-700 dark:via-gray-800 dark:to-darker">
                    <div class="relative flex h-full flex-col gap-6 rounded-2xl bg-gray-100 p-8 dark:bg-gray-900">
                        <img class="w-10" src="/images/card.webp" alt="payment card icon illustration" height="512"
                             width="512">
                        <div>
        ...
        <div class="mx-auto flex flex-col items-center gap-6 sm:w-4/5 md:w-full md:flex-row lg:gap-12">
            <div class="relative md:w-1/2">
                <div aria-hidden="true"
                    ...
                    <div
                        class="h-full rounded-full bg-gradient-to-br from-primary to-purple-400 blur-[106px] dark:from-blue-700"></div>
                    <div class="h-full bg-gradient-to-r from-cyan-400 to-primary blur-[106px] dark:to-indigo-600"></div>
                </div>
                <img class="relative dark:hidden" src="/images/illus.webp" alt="stats illustration" width="1746"
                     height="1746">
                <img class="relative hidden dark:block" src="/images/illus-dark.webp" alt="stats illustration"
                     width="1746" height="1746">
            </div>
            <div class="ml-auto h-full md:w-1/2">
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white md:text-3xl lg:text-4xl">Go beyond with our
                    top products</h3>
                <p class="my-12 text-gray-600 dark:text-gray-300">
                ...
                <a href="/pages/register.html"
                   class="relative flex h-11 w-max items-center justify-center px-5 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95"
                   type="{type}">
